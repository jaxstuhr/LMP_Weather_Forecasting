---
title: "Reading and Cleaning Weather Forecasts + LMPs"
author: "Jaxon Stuhr"
date: "2022-11-18"
...
```{r}
weather_1 = c(pd$read_pickle(fc_weather_files[1]))
```


```{r}
# testing GZip compression
weather_test = build_weather_data_frame(fc_weather_files[1:5])
```

```{r}
filtered_weather = weather_test %>% 
  filter(year == 2019,
         month == 10,
         day == 1, 
         hour == 3)
